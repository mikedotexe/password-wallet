...
var CONTRACT_NAME = undefined || 'wallet-example';
/* TODO: fill this in! */
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/mike", "/.near/validator_key.json"),
...
},{}],"new-account.js":[function(require,module,exports) {
"use strict";
...
var plainUsername = document.getElementById('plain-username');
var publicKey = document.getElementById('public-key');
var username = document.getElementById('username');
var privateKey = document.getElementById('private-key'); // const submitButton = document.getElementById('submit-new');

var loginForm = document.getElementById('login');
plainUsername.addEventListener('input', updatePlainUsername); // publicKey.addEventListener('input', updatePublicKey);
// username.addEventListener('input', updateUsername);

privateKey.addEventListener('input', updatePrivateKey); // submitButton.addEventListener('click', submitNew);

loginForm.addEventListener('submit', submitForm);

function updatePlainUsername(e) {
  username.value = "".concat(e.target.value, ":").concat(derivePublicKey());
...
function updatePrivateKey(e) {
  publicKey.value = derivePublicKey();
}
...
function submitNew(e) {
  ...
  history.replaceState({
    submitted: true
  }, "NEAR account added", "?submitted=true");
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","new-account.js"], null)
//# sourceMappingURL=/new-account.98b845e2.js.map